...
public class MarbleSolitaireModelImplTest {
  ...
  private final MarbleSolitaireModel msm1 = new MarbleSolitaireModelImpl();
  private final MarbleSolitaireModel msm2 = new MarbleSolitaireModelImpl(4, 2);
  private final MarbleSolitaireModel msm3 = new MarbleSolitaireModelImpl(5);
  private final MarbleSolitaireModel msm4 = new MarbleSolitaireModelImpl(5, 4, 4);
  private final MarbleSolitaireModel msmdefault = new MarbleSolitaireModelImpl(3);
  private final MarbleSolitaireModel msmdefault2 = new MarbleSolitaireModelImpl(3, 3, 3);

  @Test
  public void testInvalidArmSizeConstructor() {
    try {
      MarbleSolitaireModel test = new MarbleSolitaireModelImpl(2);
    ...
    try {
      MarbleSolitaireModel test = new MarbleSolitaireModelImpl(4);
      fail("Invalid constructor should have thrown exception");
    } catch (IllegalArgumentException iae) {
      assertEquals("Arm thickness must be a positive odd integer!", iae.getMessage());
      assertTrue(iae.getMessage().length() > 0);
    ...
    try {
      MarbleSolitaireModel test = new MarbleSolitaireModelImpl(0);
      fail("Invalid constructor should have thrown exception");
    } catch (IllegalArgumentException iae) {
      assertEquals("Arm thickness must be a positive odd integer!", iae.getMessage());
      assertTrue(iae.getMessage().length() > 0);
    ...
    try {
      MarbleSolitaireModel test = new MarbleSolitaireModelImpl(-1);
      fail("Invalid constructor should have thrown exception");
    } catch (IllegalArgumentException iae) {
      assertEquals("Arm thickness must be a positive odd integer!", iae.getMessage());
      assertTrue(iae.getMessage().length() > 0);
  ...
  public void testInvalidArmRowColConstructor() {
    try {
      MarbleSolitaireModel test = new MarbleSolitaireModelImpl(5, 0, 0);
      fail("Invalid constructor should have thrown exception");
    } catch (IllegalArgumentException iae) {
    ...
    try {
      MarbleSolitaireModel test = new MarbleSolitaireModelImpl(5, 0, 13);
      fail("Invalid constructor should have thrown exception");
    } catch (IllegalArgumentException iae) {
    ...
    try {
      MarbleSolitaireModel test = new MarbleSolitaireModelImpl(5, 14, 0);
      fail("Invalid constructor should have thrown exception");
    } catch (IllegalArgumentException iae) {
    ...
    try {
      MarbleSolitaireModel test = new MarbleSolitaireModelImpl(5, 13, 14);
      fail("Invalid constructor should have thrown exception");
    } catch (IllegalArgumentException iae) {
    ...
    try {
      MarbleSolitaireModel test = new MarbleSolitaireModelImpl(2, 6, 6);
      fail("Invalid constructor should have thrown exception");
    } catch (IllegalArgumentException iae) {
      assertEquals("Arm thickness must be a positive odd integer!", iae.getMessage());
      assertTrue(iae.getMessage().length() > 0);
    ...
    try {
      MarbleSolitaireModel test = new MarbleSolitaireModelImpl(0, 6, 6);
      fail("Invalid constructor should have thrown exception");
    } catch (IllegalArgumentException iae) {
      assertEquals("Arm thickness must be a positive odd integer!", iae.getMessage());
      assertTrue(iae.getMessage().length() > 0);
    ...
    try {
      MarbleSolitaireModel test = new MarbleSolitaireModelImpl(-1, 6, 6);
      fail("Invalid constructor should have thrown exception");
    } catch (IllegalArgumentException iae) {
      assertEquals("Arm thickness must be a positive odd integer!", iae.getMessage());
      assertTrue(iae.getMessage().length() > 0);
  ...
  public void testInvalidRowColConstructor() {
    try {
      MarbleSolitaireModel test = new MarbleSolitaireModelImpl(0, 0);
      fail("Invalid constructor should have thrown exception");
    } catch (IllegalArgumentException iae) {
      assertEquals("Invalid empty cell position (0,0)", iae.getMessage());
      assertTrue(iae.getMessage().length() > 0);
    ...
    try {
      MarbleSolitaireModel test = new MarbleSolitaireModelImpl(0, 5);
      fail("Invalid constructor should have thrown exception");
    } catch (IllegalArgumentException iae) {
    ...
    try {
      MarbleSolitaireModel test = new MarbleSolitaireModelImpl(6, 0);
      fail("Invalid constructor should have thrown exception");
    } catch (IllegalArgumentException iae) {
    ...
    try {
      MarbleSolitaireModel test = new MarbleSolitaireModelImpl(5, 6);
      fail("Invalid constructor should have thrown exception");
    } catch (IllegalArgumentException iae) {
  ...
  public void testInvalidRowColConstructorNeg() {
    try {
      MarbleSolitaireModel test = new MarbleSolitaireModelImpl(-1, 3);
      fail("Invalid constructor should have thrown exception");
    } catch (IllegalArgumentException iae) {
    ...
    try {
      MarbleSolitaireModel test = new MarbleSolitaireModelImpl(3, -2);
      fail("Invalid constructor should have thrown exception");
    } catch (IllegalArgumentException iae) {
  ...
  public void testRecreateDefaultConstructor() {
    ...
    assertEquals(32, msmdefault.getScore());
    ...
    assertEquals("    O O O\n"
        ...
        + "    O O O", msmdefault.getGameState());
    assertFalse(msmdefault.isGameOver());
    assertEquals(31, msmdefault.getScore());
    ...
    assertEquals(32, msmdefault2.getScore());
    ...
    assertEquals("    O O O\n"
        ...
        + "    O O O", msmdefault2.getGameState());
    assertFalse(msmdefault2.isGameOver());
    assertEquals(31, msmdefault2.getScore());
  }
  ...
  public void testArmRowColConstructor() {
    ...
    assertEquals(104, msm4.getScore());
    ...
    assertEquals("        O O O O O\n"
        ...
        + "        O O O O O", msm4.getGameState());
    assertFalse(msm4.isGameOver());
    assertEquals(103, msm4.getScore());
  }
  ...
  public void testArmSizeConstructor() {
    ...
    assertEquals(104, msm3.getScore());
    ...
    assertEquals("        O O O O O\n"
        ...
        + "        O O O O O", msm3.getGameState());
    assertFalse(msm3.isGameOver());
    assertEquals(103, msm3.getScore());
  }
  ...
  public void testFullGameWin() {
    ...
    msm1.move(3, 1, 3, 3);
    assertFalse(msm1.isGameOver());
    assertEquals(3, msm1.getScore());
    msm1.move(4, 3, 2, 3);
    assertFalse(msm1.isGameOver());
    assertEquals(2, msm1.getScore());
    msm1.move(1, 3, 3, 3);
